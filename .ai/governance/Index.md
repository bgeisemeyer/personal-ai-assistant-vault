...
- How user defaults are set through onboarding and `User-Profile.md`

## Rule Priority
1. `Safety.md`
2. Explicit user instruction
3. Local context in the nearest `Index.md`
4. User defaults from `User-Profile.md`
...
- Initial user configuration is captured through onboarding and `User-Profile.md`.
...
- `User-Profile.md`: durable user-level preferences such as language, structure, and safety posture
...
4. Use `User-Profile.md` for user-level defaults such as language and structure preferences.
