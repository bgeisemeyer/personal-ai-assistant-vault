...
## Purpose
- Short chronological project log.
- New entries go on top.

### 30.03.2026 09:04
- Author: AI-assisted project setup
...
- Result: The project folder now contains entry points, working files, and a first `.ai` structure for the public framework.
